...
const GetTenantOwner = () => {
	...
	const { data: instance } = useQuery('instance', () => erc1155.checkInstance!(account!), {
		enabled: !!erc1155.factoryContract,
	});

	const { data, isLoading } = useQuery('owner', () => erc1155.getTenantOwner!(), {
...
;
	...
	return (
		<Box>
			<h4>Get Tenant Owner</h4>
			<p>Copy tenant owner to clipboard</p>
			<Content>
